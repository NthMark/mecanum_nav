...
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, ExecuteProcess, GroupAction, RegisterEventHandler
...
def generate_launch_description():
    ...
    # delay_to_mapserver_exit = RegisterEventHandler(
    #     OnProcessExit(
    ...
    # delay_to_amcl_exit = RegisterEventHandler(
    #     OnProcessExit(
